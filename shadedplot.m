...
% plot the line edges
hold on 
hb = plot(x, y1, 'LineStyle', 'none');%
hc = plot(x, y2, 'LineStyle', 'none');%
hold off
...
switch length(varargin)
    case 0
    case 1
        set(	(2), 'FaceColor', [153 187 255]./255)%varargin{1}
    case 2
        set(ha(2), 'FaceColor', [153 187 255]./255)%varargin{1}
        set(hb, 'Color', [153 187 255]./255)%
        set(hc, 'Color', [153 187 255]./255)
    otherwise
end
